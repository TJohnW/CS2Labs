 ...
 * 
 * Version:
 *  $Id: CannonballRun.java,v 1.1 2010/03/15 01:09:03 jeh Exp $
 * Revisions:
 *  $Log: CannonballRun.java,v $
...

    ...
    public CannonballRun(String filename) throws FileNotFoundException {
        ...
        while (in.hasNextLine()) {
            ...
            //         Road road_name speed_limit length 
            if (fields[0].equals("Road")) {
                road = new Road(fields[1], new Integer(fields[2]));
                ...
                Vehicle vehicle = new Vehicle(fields[1], new Integer(fields[2]),
                        new Double(fields[3]), new Integer(fields[4]));
